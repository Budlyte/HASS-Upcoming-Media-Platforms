    ...
    def extra_state_attributes(self):
        ...
        for show in self.data:
            ...
            if 'seriesId' in show:
                ...
                card_item['poster'] = 'http{0}://{1}:{2}/{3}api/v3/mediacover/{4}/poster-250.jpg?apikey={5}'.format(self.ssl, self.host,self.port,self.urlbase,showid,self.apikey)
                card_item['fanart'] = 'http{0}://{1}:{2}/{3}api/v3/mediacover/{4}/fanart.jpg?apikey={5}'.format(self.ssl, self.host,self.port,self.urlbase,showid,self.apikey)
            else:
                showid = ''
                card_item['poster'] = ''
                card_item['fanart'] = ''
